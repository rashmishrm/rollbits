...
import com.sjsu.rollbits.datasync.server.ServerHandler;
...
public class UdpServerInit extends ChannelInitializer<SocketChannel> {
	boolean compress = false;
	RoutingConf conf;


	public UdpServerInit(RoutingConf conf, boolean enableCompression) {
		super();
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		pipeline.addLast("handler", new UdpServerHandler(conf));
	}
}
